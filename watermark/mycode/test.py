...
parser.add_argument('--origin', default='origin.jpg',
                    help='origin image file, length and width must be a multiple of 8')
...
parser.add_argument("--image_segments_num", default=1, type=int,
                    help="The sqrt number of image's segments, may be 1,2,4")
